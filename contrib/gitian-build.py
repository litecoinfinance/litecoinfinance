...
def setup():
    ...
    if not os.path.isdir('bitcoin-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/litecoinfinance/litecoinfinance-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('bitcoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/litecoinfinance/litecoinfinance.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/litecoinfinance/litecoinfinance', help='Specify the URL of the repository. Default is %(default)s')

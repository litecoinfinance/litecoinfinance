...
const std::string CURRENCY_UNIT = "LTFN"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    LTFN_KVB,      //!< Use LTFN/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from LTFN/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::LTFN_KVB) const;

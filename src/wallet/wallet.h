...
#ifndef LITECOINFINANCE_WALLET_WALLET_H
#define LITECOINFINANCE_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! litecoin finance from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this litecoin finance node, and set to 0 for transactions that were created
...
#endif // LITECOINFINANCE_WALLET_WALLET_H

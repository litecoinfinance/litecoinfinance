...
#ifndef LITECOINFINANCE_TEST_SCRIPTNUM10_H
#define LITECOINFINANCE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Litecoin Finance Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // LITECOINFINANCE_TEST_BIGNUM_H

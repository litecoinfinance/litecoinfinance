...
{
    BOOST_CHECK(TestSplitHost("www.ltfn.scalaris.info", "www.ltfn.scalaris.info", -1));
    BOOST_CHECK(TestSplitHost("[www.ltfn.scalaris.info]", "www.ltfn.scalaris.info", -1));
    BOOST_CHECK(TestSplitHost("www.ltfn.scalaris.info:80", "www.ltfn.scalaris.info", 80));
    BOOST_CHECK(TestSplitHost("[www.ltfn.scalaris.info]:80", "www.ltfn.scalaris.info", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:39328", "127.0.0.1", 39328));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:39328", "127.0.0.1", 39328));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:39328", "::ffff:127.0.0.1", 39328));
    BOOST_CHECK(TestSplitHost("[::]:39328", "::", 39328));
    BOOST_CHECK(TestSplitHost("::39328", "::39328", -1));
    BOOST_CHECK(TestSplitHost(":39328", "", 39328));
    BOOST_CHECK(TestSplitHost("[]:39328", "", 39328));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:39328", "127.0.0.1:39328"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:39328", "[::]:39328"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));

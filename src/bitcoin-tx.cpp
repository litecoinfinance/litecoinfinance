...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s litecoinfinance-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  litecoinfinance-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litecoinfinance transaction") + "\n" +
              "  litecoinfinance-tx [options] -create [commands]   " + _("Create hex-encoded litecoinfinance transaction") + "\n" +
              "\n";

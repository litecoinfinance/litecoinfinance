...
#ifndef LITECOINFINANCE_INTERFACES_NODE_H
#define LITECOINFINANCE_INTERFACES_NODE_H
...
//! Top-level interface for a litecoin finance node (litecoinfinanced process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // LITECOINFINANCE_INTERFACES_NODE_H

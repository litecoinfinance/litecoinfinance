...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, LitecoinFinanceUnits::SeparatorStyle separators=LitecoinFinanceUnits::separatorStandard) const;
...
#endif // LITECOINFINANCE_QT_TRANSACTIONTABLEMODEL_H

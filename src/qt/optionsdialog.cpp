    ...
    mapper(nullptr)
{
    ...
    ui->litecoinfinanceAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->litecoinfinanceAtStartup);
    ...
    ui->litecoinfinanceAtStartup->setToolTip(ui->litecoinfinanceAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->litecoinfinanceAtStartup->setText(ui->litecoinfinanceAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openLitecoinFinanceConfButton->setToolTip(ui->openLitecoinFinanceConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new LitecoinFinanceUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->litecoinfinanceAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLitecoinFinanceConfButton_clicked()
{
    ...
    if (!GUIUtil::openLitecoinFinanceConf())

    ...
    platformStyle(_platformStyle)
{
    ...
    // normal litecoin finance address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying litecoin finance address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &LitecoinFinanceAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

...
#include <config/litecoinfinance-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatLitecoinFinanceURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + LitecoinFinanceUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatLitecoinFinanceURI(info));
}

...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Litecoin Finance Core copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Litecoin Finance Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Litecoin Finance Core developers";
    }

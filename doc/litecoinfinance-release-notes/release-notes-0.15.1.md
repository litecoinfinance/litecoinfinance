...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mLTFN per kB (0.00001 LTFN). This is to prepare for dropping the minimum transaction fee to 0.1 mLTFN per kB (0.0001 LTFN) in the next release.

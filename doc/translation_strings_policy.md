...
This document provides guidelines for internationalization of the Litecoin Finance Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `litecoinfinance_en.ts` remains unchanged.

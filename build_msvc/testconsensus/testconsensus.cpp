...
// litecoin finance includes.
#include <..\src\script\litecoinfinanceconsensus.h>
...
int main()
{
    std::cout << "litecoinfinanceconsensus version: " << litecoinfinanceconsensus_version() << std::endl;
    ...
    auto op0Result = litecoinfinanceconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, litecoinfinanceconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);

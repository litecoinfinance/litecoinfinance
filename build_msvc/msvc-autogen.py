...
libs = [
    'liblitecoinfinance_cli',
    'liblitecoinfinance_common',
    'liblitecoinfinance_crypto',
    'liblitecoinfinance_server',
    'liblitecoinfinance_util',
    'liblitecoinfinance_wallet_tool',
    'liblitecoinfinance_wallet',
    'liblitecoinfinance_zmq',
]

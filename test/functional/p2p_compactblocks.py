...
# TestP2PConn: A peer we use to send messages to litecoinfinanced, and store responses.
...
class CompactBlocksTest(LitecoinFinanceTestFramework):
    ...
    # This test actually causes litecoinfinanced to (reasonably!) disconnect us, so do this last.
    ...
    # litecoinfinanced's choice of nonce.
    ...
    # Test that litecoinfinanced requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for litecoinfinanced to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # litecoinfinanced will not send blocktxn responses for blocks whose height is

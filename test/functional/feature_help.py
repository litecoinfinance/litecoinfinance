...
"""Verify that starting litecoin finance with -h works as expected."""

from test_framework.test_framework import LitecoinFinanceTestFramework
from test_framework.util import assert_equal

class HelpTest(LitecoinFinanceTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litecoin finance with -h for help text")
        ...
        self.log.info("Start litecoin finance with -version for version information")
        ...
        self.log.info("Start litecoinfinanced with -fakearg to make sure it does not start")
